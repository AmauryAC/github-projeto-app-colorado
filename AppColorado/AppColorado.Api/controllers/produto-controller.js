...
module.exports.post = async(req, res) => {
    ...
    _validationContract.isRequired(req.body.categoria, 'Informe a categoria a que pertence o produto.');
    _validationContract.isRequired(req.body.comercio, 'Informe o comércio a que pertence o produto.');
    _validationContract.isTrue(req.body.preco < 0, 'O valor do produto tem que ser maior que R$0,00.');
